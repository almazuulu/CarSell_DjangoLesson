...
from .views import AllCarsView, CarDetailsView, SearchView, CarCreateView, CarDeleteView, UpdateCar, ownerscars
urlpatterns = [
    path('', AllCarsView.as_view(), name = 'cars'),
    path('search', SearchView.as_view(), name='search'),
    path('add_car',CarCreateView.as_view(), name='add_car'),
    path('ownerscars/<str:id>', ownerscars, name = 'ownerscars'),
